  ...
  <div class="card-content form-card">
    ...
    <div class="row-nowrap spaceBetween">
      <p class="col-L10 col-S12">Votre surface est composée d’un stand type, fourni par l’organisateur.
        <br /> Les exposants devront obligatoirement respecter les dimensions du stand qui leur sera fourni (hauteur et surface
        au sol). Il est strictement interdit de démonter tout ou partie des structures organisateur.</p>
